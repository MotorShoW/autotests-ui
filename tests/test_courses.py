...
def test_empty_courses_list(chromium_page_with_state):
    ...
    # Проверка заголовка
    courses_empty_header = chromium_page_with_state.get_by_test_id('courses-list-toolbar-title-text')
    ...
    # Проверка блока
    courses_empty_list = chromium_page_with_state.get_by_test_id('courses-list-empty-view-title-text')
